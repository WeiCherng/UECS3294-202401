        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('editEmpEdu', $data->id) }}" method="POST">
                        @csrf
                        <!-- Course Program input -->
                        <div class="form-group">
                            <label for="CourseProgram">Course Program</label>
                            <input type="text" class="form-control" id="CourseProgram" name="CourseProgram"
                                value="{{ old('CourseProgram', $data->CourseProgram) }}" required>
                        </div>
                        ...
                        <!-- Year Graduated input -->
                        <div class="form-group">
                            <label for="YearGraduate">Year Graduated</label>
                            <input type="text" class="form-control" id="YearGraduate" name="YearGraduate"
                                value="{{ old('YearGraduate', $data->YearGraduate) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Achievements" name="Achievements"
                                value="{{ old('Achievements', $data->Achievements) }}">
                        </div>
